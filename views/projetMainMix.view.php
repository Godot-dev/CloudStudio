                            ...
                            <div class="collapse navbar-collapse" id="navcol-2">
                                <ul class="nav navbar-nav">
                                    ...
                                    <form method=POST action=#>
                                        ...
                                        <input type="hidden" name="newstems" value="false"></input>
                                        <input type="hidden" name="nouvelleVersion" value="rien"></input>
                                        <li class="nav-item"><button class="btn text-capitalize nav-link active" id="ProjectNavItems" type="submit">Mix</button></li>
                                    </form>
                        ...
                        if (!empty($nouvelleVersion)) { ?>
                            <div class="row" id="CurrentVersion">
                                ...
                                <div class="col text-right">
                                    ...
                                    <form id="BTNProjectSelectItems" method=POST action=../controler/projetMainMix.ctrl.php>
                                ...
                                if ($version == $versionAAfficher) { ?>
                                    <div class="row" id="CurrentVersion">
                                        ...
                                        <div class="col text-right">
                                            ...
                                            <form id="formDelete" method=POST action=../controler/projetMainMix.ctrl.php>
                                                <input type="hidden" name="nomProjet" value=<?= $nomProjet ?>></input>
                                                <input type="hidden" name="idProjet" value=<?= $idProjet ?>></input>
                                                <input type="hidden" name="versionCliquee" value=<?= $versionAAfficher->id ?>></input>
                                                <input type="hidden" name="newstems" value="false"></input>
                    ...
                    <div class="row">
                        <div class="col-md-6" id="description">
                            <?php if (empty($nouvelleVersion)) { ?>
                                <form id="DescriptionForm" method=POST action=../controler/projetMainMix.ctrl.php>
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col" id="preview">
                                    <h1 class="text-capitalize" id="HBlack">preview</h1><audio class="border rounded-pill" controls src=<?= "../data/Projets/$idProjet/Mix/v$versionAAfficher->id/cloudStudioPreview.mp3" ?>></audio>
                                    <form id="DescriptionForm" enctype="multipart/form-data" action="../controler/projetMainMix.ctrl.php" method="post">
                                        <input type="hidden" name="nomProjet" value=<?= $nomProjet ?>></input>
                                        <input type="hidden" name="idProjet" value=<?= $idProjet ?>></input>
                                        <input type="hidden" name="versionCliquee" value=<?= $versionAAfficher->id ?>></input>
                                        <input type="hidden" name="newstems" value="false"></input>
                            ...
                            <div class="row">
                                <div class="col" id="downloadV">
                                    ...
                                    <form id="DescriptionForm" action="../controler/projetMainMix.ctrl.php" method="post">
                                        <input type="hidden" name="nomProjet" value=<?= $nomProjet ?>></input>
                                        <input type="hidden" name="idProjet" value=<?= $idProjet ?>></input>
                                        <input type="hidden" name="versionCliquee" value=<?= $versionAAfficher->id ?>></input>
                                        <input type="hidden" name="newstems" value="false"></input>
                                    ...
                                    <?php if (!empty($newstems)) { ?>
                                        <div class="m-5" id="UploadZone">
                                            ...
                                            <div class="jumbotron pt-1" id="jumbotronDrop">
                                                ...
                                                <form method="post" enctype="multipart/form-data" action="../controler/projetMainMix.ctrl.php">
                                        ...
                                        foreach ($listeStems as $stems) { ?>
                                            <div class="row" id="StemsItems">
                                                ...
                                                <div class="col-md-auto d-flex flex-nowrap justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center" id="dlColStems">
                                                    <a href="<?= $dao->getURLFichierMix($idProjet, $versionAAfficher->id, $stems) ?>" download="">
                                                        <button class="btn btn-dark" id="btnDownloadStems" type="button">
                                                            <img src="../assets/img/dl2.png" width="27px" height="27px"></button>
                                                    </a>
                                                    <form action="../controler/projetMainMix.ctrl.php" method=POST>
