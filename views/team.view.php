        ...
        <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" id="arianne" href="#">Team</a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
            </div>
    ...
    <div class="projects-clean">
        <div class="container">
            <div class="intro">
                ...
                <p class="text-center">Here you can find all the informations about the wonderful people who made that website</p>
            </div>
            <div class="row projects">
                <div class="col-sm-6 col-lg-4 item"><img src="../assets/img/team/eden.png" style="width:20em;height:25em;">
                    <h3 class="name">Eden Porte</h3>
                    <p class="description">A nice guy, who is an expert in database, DAO, and other mysticals stuffs.</p>
                </div>
                <div class="col-sm-6 col-lg-4 item"><img src="../assets/img/team/luka.png" style="width:20em;height:25em;">
                    <h3 class="name">Luka Larguier</h3>
                    <p class="description">A pro Geometry Dash player who is actually an awesome sequential diagrams maker.</p>
                </div>
                <div class="col-sm-6 col-lg-4 item"><img src="../assets/img/team/william.png" style="width:20em;height:25em;">
                    <h3 class="name">William Berruyer</h3>
                    <p class="description">The white Eminem. And also a genius webdesigner.</p>
                </div>
                <div class="col-sm-6 col-lg-4 item"><img src="../assets/img/team/antoine.png" style="width:20em;height:25em;">
                    <h3 class="name">Antoine Gros</h3>
                    <p class="description">The boss of the team. A strong brain, and awesome body, and you have some kind of a real dude !</p>
                </div>
                <div class="col-sm-6 col-lg-4 item"><img src="../assets/img/team/emerick.png" style="width:20em;height:25em;">
                    <h3 class="name">Emerick Measson</h3>
                    <p class="description">A database profesionnal, combined with an huge chat widget knowledge.</p>
                </div>
                <div class="col-sm-6 col-lg-4 item"><img src="../assets/img/team/alain.png" style="width:20em;height:25em;">
                    <h3 class="name">Alain Baptista</h3>
                    <p class="description">He was here. I guess.</p>
                </div>
            </div>
        </div>
    </div>
