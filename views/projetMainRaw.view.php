                                ...
                                <div class="col" id="downloadV">
                                    ...
                                    <form id="DescriptionForm" action="../controler/projetMainRaw.ctrl.php" method="post">
                                        ...
                                        <button class="btn btn-light" id="btnDownloadStems" type="submit">
                                            <img class="img-fluid" data-toggle="tooltip" data-bs-tooltip="" data-placement="right" src="../assets/img/Groupe%2054.png" width="27px" title="Click here to create a zip file of the entire version ! (it is added in the files section)">
                                        </button>
                                    </form>
                                </div>
