        ...
        <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    <li class="nav-item"></li>
                    <li class="nav-item"><a class="nav-link" href="home.ctrl.php">Home</a></li>
                    <li class="nav-item"><a class="nav-link" id="arianne" href="#">Logout</a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
            </div>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form action="disconnect.ctrl.php" method="post">
                <h2 class="text-center"><strong>Logout&nbsp;</strong>from your account.</h2>
                <div class="form-group"><button class="btn btn-block btn-lg d-xl-flex justify-content-xl-center" id="btnLoginSignUp" type="submit">Log out</button></div>
            </form>
        </div>
    </div>
