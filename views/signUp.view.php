        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" id="CSsites" href="#page-top">CloudStudio</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-align-justify"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" id="pagesSite" href="#">About</a></li>
        ...
        <div class="form-container">
            <form method="post" action="../controler/inscrire.ctrl.php">
                ...
                <div class="form-group">
                    <div class="form-check"><label class="form-check-label"><input class="form-check-input" type="checkbox" required><a class="terms" href="../controler/termscondition.ctrl.php">I agree to the license terms.</a></label></div>
                </div>
                <div class="form-group"><button id="btnLoginSignUp" class="btn btn-block btn-lg d-xl-flex justify-content-xl-center" type="submit">Sign Up</button></div><a class="already" href="../controler/login.ctrl.php">You already have an account? Login here.</a>
            </form>
        </div>
    </div>
