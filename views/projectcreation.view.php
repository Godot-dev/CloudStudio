        ...
        <div class="container" id="projectCreation">
            ...
            <div class="row" style="width: 100%;">
                <div class="col-md-12" id="ProfilSelecRow2">
                    <p class="ProjectP">Projects</p><small>Create your project</small><a href="../controler/projects.ctrl.php"><button class="btn" id="Plus" type="button"><img src="../assets/img/Groupe%2057.png"></button></a>
                </div>
            </div>
