...
<body id="page-top">
    ...
    <hr>
    <nav class="navbar navbar-light navbar-expand-md" id="arianneCont">
    ...
    <div>
        <div class="container" id="projectCreation">
            <div class="row d-xl-flex" id="profilRow">
                <div class="col-md-12 offset-xl-0"><img id="ProfilePic" src=<?= $profilePic ?>>
                    <p class="profilPic"><?= $name ?></p><small><?= $mail ?></small>
                </div>
            </div>
            <div class="row" style="width: 100%;">
                <div class="col-md-12" id="ProfilSelecRow2">
                    <p class="ProjectP">Projects</p><small>All your projects</small><a href="../controler/newProject.ctrl.php"><button class="btn" id="Plus" type="button"><img src="../assets/img/Groupe%2054.png"></button></a>
                </div>
            </div>
                        ...
                        <?php if (sizeof($listeProjet) == 0) { ?>
                            ...
                            foreach ($listeProjet as $projet) { ?>
                                <tr>
                                    <td><?= $projet->nom ?></td>
                                    <td id="openTD">
                                        <form id="OpenProject" method=post action=../controler/projetMainRaw.ctrl.php>
                                            <input type="hidden" name="nomProjet" value="<?= $projet->nom ?>"></input>
                                            <input type="hidden" name="idProjet" value=<?= $projet->id ?>></input>
                                            ...
                                            <button class="btn" id="Open" type="submit">Open</button>
                                        </form>
                                        <form id="DeleteProject" method=post action=../controler/projects.ctrl.php>
                                            <input type="hidden" name="idProjetASuppr" value=<?= $projet->id ?>></input>
                                            <button class="btn" id="btnDeleteProjects" type="submit" onclick="return confirm('Are you sure that you want to delete this project?')">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                        <?php
