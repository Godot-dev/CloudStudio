                ...
                <ul class="nav navbar-nav ml-auto">
                  <?php
                    if (empty($_SESSION['User'])){ ?>
                      <li class="nav-item"><a class="nav-link js-scroll-trigger" href="../controler/about.ctrl.php">About</a></li>
                      ...
                      <li class="nav-item"><a class="nav-link js-scroll-trigger" href="../controler/help.ctrl.php">Help</a></li>
                      <?php
                    }else{
                  ?>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="../controler/settings.ctrl.php">Account</a></li>
