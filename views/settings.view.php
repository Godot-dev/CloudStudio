...
<body id="page-top">
        ...
        <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" id="arianne" href="#">Account Settings</a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
            </div>
    ...
    <div class="register-photo">
        ...
        <div class="col">
            <div class="container d-xl-flex justify-content-xl-center profile profile-view" id="profile">
                <form style="width: 1035px;" enctype="multipart/form-data" method="post" action="../controler/settings.ctrl.php">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group"><label>Surname </label><input class="form-control" type="text" name="prenom" placeholder=<?=$Firstname?>></div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group"><label>Name </label><input class="form-control" type="text" name="nom" placeholder=<?=$Lastname?>></div>
                                </div>
                            </div>
                            <div class="form-group"><label>Email </label><input class="form-control" type="email" autocomplete="off" name="email" placeholder=<?=$mail?>></div>
                            <div class="form-row">
                                <div class="col-sm-12 col-md-6">
                            ...
                            <hr id="hrLight">
                            <div class="form-row">
                                <div class="col-md-12 content-right form-groups"><button class="btn btn-light form-btn" id="btnSave" type="submit">SAVE </button><button class="btn btn-danger form-btn" type="reset">CANCEL </button></div>
                            </div>
                        </div>
                    </div>
                </form>
